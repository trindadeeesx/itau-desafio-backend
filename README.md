...
Este repo é a resolução do desafio backend proposto pelo Itaú Unibanco. O objetivo do desafio é desenvolver uma aplicação backend que atenda aos requisitos especificados.

[Link do repositório de inspiração](https://github.com/feltex/desafio-itau-backend/)
